...
- [x] **Model catalog overhaul** (`web/lib/models.js`) — open-weight, non-reasoning, Ollama Cloud-only roster:
  ...
  - [x] qwen3-coder-next (featured; only non-thinking Qwen on Ollama Cloud; ~80B MoE)
  - [x] ministral-3:14b / 8b (featured), ministral-3:3b, devstral-small-2:24b (featured)
  - [x] removed the unavailable 12B Google Gemma tag
